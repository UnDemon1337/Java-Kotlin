...
import com.example.chaikinweather.data.LiveDataEvent
...
class HomeViewModel(private val weatherDataRepository: WeatherDataRepository ): ViewModel() {
    ...
    fun getCurrentLocation(
        ...
        viewModelScope.launch {
            ...
            weatherDataRepository.getCurrentLocation(
                ...
                onFailure = { emitCurrentLocationUiState(error = "Failed to get current location") }
            )
        }
    }
    ...
    private fun emitWeatherDataUiState(
        ...
        forecast: List<ForecastWeather>? = null,
        error: String? = null
    ) {
